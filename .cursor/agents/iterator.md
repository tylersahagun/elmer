...
- `@elmer-docs/initiatives/[name]/_meta.json`
- `@elmer-docs/initiatives/[name]/prd.md`
- `@elmer-docs/initiatives/[name]/design-brief.md`
- `@elmer-docs/initiatives/[name]/prototype-notes.md`
- `@elmer-docs/initiatives/[name]/jury-evaluations/` (latest)

## Workflow

### Step 1: Locate Initiative Docs

Find all relevant files in `elmer-docs/initiatives/[name]/`

### Step 2: Auto-Pull Signals

1. Read signals index: `elmer-docs/signals/_index.json`
...
```
prototypes/src/components/[Initiative]/v[N+1]/
├── [ComponentName].tsx
