...
- Target directory in `@orchestrator/src/` or `@prototypes/src/`
...
- Related initiatives in `elmer-docs/initiatives/`
- User research in `elmer-docs/research/`
...
- Source: `orchestrator/src/components/integrations/hubspot/`
- Docs: `pm-workspace-docs/agents-docs/orchestrator/components/integrations/hubspot/AGENTS.md`
