...
**Output:** `pm-workspace-docs/status/maintenance-audit.md`
...
1. `pm-workspace-docs/roadmap/roadmap.json`
2. `pm-workspace-docs/roadmap/roadmap.md`
3. `pm-workspace-docs/roadmap/roadmap-gantt.md`
4. `pm-workspace-docs/roadmap/roadmap-kanban.md`
5. `pm-workspace-docs/hypotheses/_index.json`
6. `pm-workspace-docs/signals/_index.json`
...
**Report:** pm-workspace-docs/status/maintenance-audit.md
