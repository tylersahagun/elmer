...
**Output:** Save report to `pm-workspace-docs/status/maintenance-audit.md`
...
The audit uses `elmer-docs/maintenance/structure-schema.json` to validate:
...
`elmer-docs/maintenance/audit-history/YYYY-MM-DD-HHMM.md`
