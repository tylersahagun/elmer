...
2. Name events in snake_case: `[object]_[action]`
...
Write to `elmer-docs/initiatives/[name]/measurement-plan.md`
...
📁 **Files:**
- `elmer-docs/initiatives/[name]/measurement-plan.md`
- Updated: `elmer-docs/initiatives/[name]/prd.md` (if metrics were vague)
