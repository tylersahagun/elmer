...
- `elmer-docs/initiatives/rep-workspace/prd.md` ✅
- `elmer-docs/initiatives/rep-workspace/research.md` ✅
- `elmer-docs/initiatives/rep-workspace/prototype-notes.md` ✅
- `elmer-docs/initiatives/rep-workspace/design-brief.md` ❌ Missing
- `elmer-docs/initiatives/rep-workspace/placement-research.md` ✅
