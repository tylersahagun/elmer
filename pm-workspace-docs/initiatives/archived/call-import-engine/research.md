...
## Customer Signal: Hexcode (Kelly Taylor) - Fathom Import

**Company:** Hexcode (hexcode.ai) - created 2025-10-31  
**Primary Contact:** Kelly Taylor (kelly@hexcode.ai)

### The Request

- Import ~1,000 historical Fathom calls into AskElephant
- API or batch import that extracts attendee emails, meeting metadata, and transcripts
- Bulk privacy management for imported calls to preserve original privacy settings

### Timeline

1. **2025-12-31 | Initial Demo (Kelly / Reuben | AskE Demo)**
   - Action item: Investigate call import API capabilities
   - Context: 7-8 users at $31/user/month, transitioning from Fathom
2. **2026-01-15 | Comprehensive Onboarding (Onboarding - AskElephant)**
   - Critical action: Transfer ~1,000 Fathom calls (target week of 2026-01-15 to 2026-01-22)
   - 14 workflows deployed (Meeting Prep, Coach, Recap Email, HubSpot integrations)
   - Default privacy set to private; follow-up scheduled for Thu at 3 PM
3. **2026-01-22 | Follow-up Onboarding**
   - Brief 9-minute check-in with Erika Vasquez and Kelly Taylor

### Related Asks

- Dev standup automation (meeting-type detection + Slack summaries)
- Inbound webhooks / CRM-triggered automation (GoHighLevel now, Salesforce later)
- Sales-to-CS handoff workflows and Make webhook integration

### Outstanding Items

- Fathom call import API investigation
- GoHighLevel integration pending
