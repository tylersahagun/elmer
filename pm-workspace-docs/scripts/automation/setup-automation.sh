...
# ============================================
# Signal Router (Every 5 minutes)
# ============================================

ROUTER_PLIST="$LAUNCH_AGENTS_DIR/com.pmworkspace.signal-router.plist"
...
<dict>
    <key>Label</key>
    <string>com.pmworkspace.signal-router</string>

    <key>ProgramArguments</key>
    <array>
        <string>/usr/bin/python3</string>
        <string>$SCRIPT_DIR/signal-router.py</string>
    </array>
    ...
    <key>StandardOutPath</key>
    <string>$WORKSPACE_ROOT/maintenance/logs/signal-router.log</string>

    <key>StandardErrorPath</key>
    <string>$WORKSPACE_ROOT/maintenance/logs/signal-router.error.log</string>
...
echo "✅ Created signal router plist"
...
echo "   launchctl load $ROUTER_PLIST"
