...
5. Check for `pm-workspace-docs/initiatives/active/[name]/competitive-landscape.md` -- if it exists, incorporate competitive evidence into the PRD. If it doesn't exist and the initiative involves a feature area where competitors are active, suggest running `/landscape [name]` first.
...
- "Have you run `/landscape` for this initiative? What do competitors do here?"
- "How does this compare to what [competitor] offers?"
- "Are we matching table stakes or creating differentiation?"
...
- [ ] Competitive landscape analysis (link to `competitive-landscape.md` if available)

### Competitive Landscape Summary

<!-- If competitive-landscape.md exists, summarize key findings here -->
<!-- Link: [Full Competitive Landscape](./competitive-landscape.md) -->

- **Market position**: [Where does AskElephant sit for this feature area?]
- **Table stakes to match**: [What must we have?]
- **Differentiation opportunity**: [Where can we lead?]
