...
_Stack research for: Multi-user authentication and workspace collaboration_
...
export const signals = pgTable(
  "signals",
  {
    ...
    frequency: text("frequency").$type<
      "widespread" | "common" | "occasional" | "rare"
    >(),
...
_Stack research for: Signal ingestion, classification, clustering, and synthesis_
_Researched: 2026-01-22_
