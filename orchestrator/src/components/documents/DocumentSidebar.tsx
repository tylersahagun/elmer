...
export function DocumentSidebar({
  ...
  return (
    <div className={cn("relative flex h-full", className)}>
      ...
      {!isOpen && (
        <div className="flex-shrink-0 h-full flex flex-col items-center py-4 px-2 bg-card border-r border-border dark:border-[rgba(255,255,255,0.14)]">
          <Button
            variant="ghost"
            size="icon"
          ...
          <div className="w-px h-8 bg-border dark:bg-[rgba(255,255,255,0.14)] mt-2" />
          <span className="text-xs text-muted-foreground [writing-mode:vertical-lr] rotate-180 mt-3">
            Documents
          </span>
        </div>
      )}
      ...
      {isOpen && (
        <motion.div
          ...
          className="h-full relative border-r border-border dark:border-[rgba(255,255,255,0.14)]"
        >
          <div 
          ...
          >
              ...
              <div className="flex items-center justify-between px-3 py-3 border-b border-border dark:border-[rgba(255,255,255,0.14)]">
                <h3 className="text-sm font-medium text-foreground font-mono">Documents</h3>
              ...
              {documents.length > 0 && onUpload && (
                <div className="p-3 border-t border-border dark:border-[rgba(255,255,255,0.14)]">
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={onUpload}
