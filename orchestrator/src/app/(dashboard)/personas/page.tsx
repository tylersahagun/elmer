...
/**
 * Legacy personas page - redirects to workspace-scoped version
 *
 * This page fetches the user's workspaces and redirects to the first
 * workspace's personas page. For proper workspace context, use
 * /workspace/[id]/personas instead.
 */
export default function PersonasPage() {
  ...
  useEffect(() => {
    if (defaultWorkspaceId) {
      router.replace(`/workspace/${defaultWorkspaceId}/personas`);
    }
